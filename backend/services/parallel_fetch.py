...
from backend.services.kaseya_client import fetch_all_kaseya_assets
...
def fetch_asset_snapshots_parallel() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    with ThreadPoolExecutor(max_workers=2) as pool:
        kaseya_future = pool.submit(fetch_all_kaseya_assets, 100, 1000)
...
async def fetch_asset_snapshots_async() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    kaseya_task = asyncio.to_thread(fetch_all_kaseya_assets, 100, 1000)
